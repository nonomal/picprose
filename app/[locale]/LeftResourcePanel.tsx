    ...
    <div className="p-4">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="flex flex-col items-center">
          <div 
            className="w-full h-40 rounded-md cursor-pointer hover:scale-105 transition-transform border border-gray-300 dark:border-gray-700 overflow-hidden"
            onClick={() => handlePatternSelect(0)}
          >
            {renderSvgPreview(0)}
          </div>
          <div className="text-center text-default-600 mt-2">
            {svgBgs[0]?.name || "Heazy波浪"}
          </div>
        </div>
